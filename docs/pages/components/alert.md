...
```html:preview
<sl-alert variant="information" open>
  <sl-icon slot="icon" name="info-circle"></sl-icon>
...
const App = () => (
  <>
    <SlAlert variant="information" open>
      <SlIcon slot="icon" name="info-circle" />
...
```html:preview
<sl-alert variant="information" open closable class="alert-closable">
  <sl-icon slot="icon" name="info-circle"></sl-icon>
...
```html:preview
<sl-alert variant="information" open> Nothing fancy here, just a simple alert. </sl-alert>
```
...
<div class="alert-duration">
  <sl-button variant="information">Show Alert</sl-button>

  <sl-alert variant="information" duration="3000" closable>
    <sl-icon slot="icon" name="info-circle"></sl-icon>
  ...
  return (
    <>
      <div className="alert-duration">
        <SlButton variant="information" onClick={() => setOpen(true)}>
          Show Alert
        </SlButton>

        <SlAlert variant="information" duration="3000" open={open} closable onSlAfterHide={() => setOpen(false)}>
          <SlIcon slot="icon" name="info-circle" />
          This alert will automatically hide itself after three seconds, unless you interact with it.
        </SlAlert>
      </div>
...
<div class="alert-toast">
  <sl-button variant="information">Information</sl-button>
...
<script>
  ...
  ['information', 'success', 'neutral', 'warning', 'danger'].map(variant => {
...
const App = () => {
  ...
  return (
    <>
      <SlButton variant="information" onClick={() => information.current.toast()}>
        Information
      </SlButton>
      ...
      <SlAlert ref={information} variant="information" duration="3000" closable>
        <SlIcon slot="icon" name="info-circle" />
        <strong>This is super informative</strong>
        <br />
        You can tell by how pretty the alert is.
...
<div class="alert-toast-wrapper">
  <sl-button variant="information">Create Toast</sl-button>
</div>
...
<script>
  ...
  function notify(message, variant = 'information', icon = 'info-circle', duration = 3000) {
