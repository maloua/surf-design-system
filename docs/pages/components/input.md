...
```html:preview
<sl-input placeholder="Small" label="Small" size="small"></sl-input>
<br />
<sl-input placeholder="Medium" label="Medium" size="medium"></sl-input>
<br />
<sl-input placeholder="Large" label="Large" size="large"></sl-input>
```
